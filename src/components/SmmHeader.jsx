      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-dark-bg border-t border-gray-700">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-dark-bg">
            ...
            <NavLink
              to="/Orders"
              className="border bg-dark-card border-card-border hover:bg-gradient-to-r from-fuchsia-400 to-purple-700 text-gray-300 hover:text-white w-full text-left px-3 py-2 rounded-md text-base font-medium"
            >
              Orders
            </NavLink>
